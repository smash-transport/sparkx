...
setup(
    ...
    author_email="nsass@itp.uni-frankfurt.de, hendrik.h.roch@jyu.fi, goetz@itp.uni-frankfurt.de, rkrupczak@physik.uni-bielefeld.de, constantin@itp.uni-frankfurt.de",
